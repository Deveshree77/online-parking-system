...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadLotInfo() {
        try {
            ...
            if (lotData) {
                ...
                document.getElementById('statRate').textContent = `₹${lotData.ratePerHour}`;
    ...
    function updateBookingSummary() {
        ...
        const amount = hours * parseFloat(lotData.ratePerHour);
