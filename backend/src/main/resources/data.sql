-- =============================================
-- SmartPark Seed Data (H2 Compatible)
-- =============================================

-- Parking Lots (5 cities across India)
INSERT INTO parking_lots (id, name, address, city, latitude, longitude, total_slots, rate_per_hour, extra_rate_per_minute, buffer_minutes, created_at) VALUES
(1, 'Phoenix Mall Parking', 'Lower Parel, Mumbai', 'Mumbai', 19.0068, 72.8312, 15, 60.00, 3.00, 15, CURRENT_TIMESTAMP),
(2, 'BKC Parking Complex', 'Bandra Kurla Complex, Mumbai', 'Mumbai', 19.0596, 72.8656, 12, 80.00, 4.00, 15, CURRENT_TIMESTAMP),
(3, 'Connaught Place Parking', 'Block A, Connaught Place, Delhi', 'Delhi', 28.6315, 77.2167, 20, 50.00, 2.50, 15, CURRENT_TIMESTAMP),
(4, 'Saket Mall Parking', 'Select Citywalk, Saket, Delhi', 'Delhi', 28.5285, 77.2192, 18, 70.00, 3.50, 10, CURRENT_TIMESTAMP),
(5, 'Orion Mall Parking', 'Dr Rajkumar Rd, Rajajinagar, Bangalore', 'Bangalore', 13.0107, 77.5556, 25, 40.00, 2.00, 15, CURRENT_TIMESTAMP),
(6, 'UB City Parking', 'Vittal Mallya Rd, Bangalore', 'Bangalore', 12.9716, 77.5972, 10, 100.00, 5.00, 10, CURRENT_TIMESTAMP),
(7, 'Amanora Mall Parking', 'Hadapsar, Pune', 'Pune', 18.5124, 73.9310, 16, 30.00, 2.00, 15, CURRENT_TIMESTAMP),
(8, 'Inorbit Mall Parking', 'HITEC City, Hyderabad', 'Hyderabad', 17.4325, 78.3827, 22, 40.00, 2.00, 15, CURRENT_TIMESTAMP);
...
(1, 'Smart Park Admin', 'admin@smartpark.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '9999999999', 'ADMIN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
